...
MANAGER_HOST = os.getenv("MANAGER_HOST", "168.144.73.18")           # Listen on all interfaces
...
# --- API Server ---
API_HOST = os.getenv("API_HOST", "168.144.73.18")
...
AGENT_ID = os.getenv("AGENT_ID", "agent-004")             # Unique ID per machine (change per install)
AGENT_HOSTNAME = os.getenv("AGENT_HOSTNAME", "7H4N05")   # Human-readable name
